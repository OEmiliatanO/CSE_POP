...
for ((i=0;i<6;++i)); do
	cp main_stack.c main_stack_${types[$i]}.c
	cp main_stack.c main_stack_${pttypes[$i]}.c
	cp main_queue.c main_queue_${types[$i]}.c
	cp main_queue.c main_queue_${pttypes[$i]}.c
done
